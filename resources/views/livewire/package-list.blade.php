<div>
    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-xl font-semibold text-zinc-900 dark:text-zinc-100">Packages</h2>
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800">
                    @forelse($packages as $package)
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition">
                            ...
                            <td class="px-6 py-4">{{ $package->duration_months }} Months</td>
                            <td class="px-6 py-4">₹{{ number_format($package->base_price, 2) }}</td>
                            <td class="px-6 py-4">
                                <button wire:click="toggleStatus({{ $package->id }})"
                                    class="px-2 py-1 text-xs rounded-full {{ $package->status === 'active' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300' }}">
