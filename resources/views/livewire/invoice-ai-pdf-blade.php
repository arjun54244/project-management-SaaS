                      ...
                      "
                            ...
                            ">
                                                    ...
                                                    <span style="font-weight: 600" id="tmp_entity_date">:
                                                        {{ $invoice->invoice_date ? \Carbon\Carbon::parse($invoice->invoice_date)->format('d/m/Y') : '-' }}</span>
                                                    ...
                                                    <span style="font-weight: 600" id="tmp_due_date">:
                                                        {{ $invoice->due_date ? \Carbon\Carbon::parse($invoice->due_date)->format('d/m/Y') : '-' }}</span>
                                                </td>
                                ...
                                <table style="width:100%; table-layout:fixed; border-collapse:collapse;"
                                    class="pcs-itemtable" cellspacing="0" cellpadding="4" border="1">

                                    <thead>
                                        <tr>
                                            <th rowspan="2" style="width:5%; text-align:center;">#</th>
                                            <th rowspan="2" style="text-align:left;">Item &amp; Description</th>
                                            <th rowspan="2" style="width:11%; text-align:right;">Qty</th>
                                            <th rowspan="2" style="width:11%; text-align:right;">Rate</th>
                                            <th colspan="2" style="width:22%; text-align:center;">IGST</th>
                                            <th rowspan="2" style="width:13%; text-align:right;">Amount</th>
                                        </tr>
                                        <tr>
                          ...
                          "
                                    ...
                                    <div style="width: 43.6%; float: right" class="pcs-totals">
                                        <table style="width:100%; border-collapse:collapse; margin-top:10px;" border="0" class="pcs-totaltable"
                                            id="itemTable" cellspacing="0" width="100%">
                                            <tbody>
                                                <tr>
