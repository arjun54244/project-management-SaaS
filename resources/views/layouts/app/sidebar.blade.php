...
<body class="min-h-screen bg-zinc-50 dark:bg-zinc-900 ocean:bg-zinc-50 forest:bg-zinc-50 rose:bg-zinc-50 sunset:bg-zinc-50 lavender:bg-zinc-50 custom-theme:bg-zinc-50">
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Subscription')" class="grid">
                <flux:sidebar.item icon="credit-card" :href="route('subscriptions.index')"
                    :current="request()->routeIs('subscriptions.*')" wire:navigate>
                    {{ __('Subscriptions') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="cube" :href="route('packages.index')"
                    :current="request()->routeIs('packages.*')" wire:navigate>
                    {{ __('Packages') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="wrench" :href="route('services.index')"
            ...
            <flux:sidebar.group :heading="__('Billing')" class="grid">
                <flux:sidebar.item icon="document" :href="route('invoices.index')"
                    :current="request()->routeIs('invoices.*')" wire:navigate>
                    {{ __('Invoices') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="banknotes" :href="route('payments.index')"
